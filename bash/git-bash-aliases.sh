...
__JH_JAVA_VERSION_DEFAULT__='8' # valid values: '8', '17', '21' (formal value in pom.xml for '8' is '1.8')
__JH_XMS_DEFAULT__='8m'
__JH_XMX_DEFAULT__='256m'
__JH_JAR_LOG_HOME_DEFAULT__=${HOME}'/Desktop/log'
__JH_SPRING_PROFILES_ACTIVE_DEFAULT__='albertodefault,albertopre,albertolocal,albertodiff' # comma separated values, no whitespace; 'default' is first and implicit; 'albertodiff' is optional from 2026-01-26

__JH_XMS__=${__JH_XMS_DEFAULT__}
__JH_XMX__=${__JH_XMX_DEFAULT__}
__JH_SPRING_PROFILES_ACTIVE__=${__JH_SPRING_PROFILES_ACTIVE_DEFAULT__}
...
function __bh_kill_all {
    ...
    k9 2> /dev/null  ; k10 2> /dev/null ; k11 2> /dev/null ; k12 2> /dev/null ;
    k13 2> /dev/null ; k14 2> /dev/null ; k15 2> /dev/null ; k16 2> /dev/null ;
    jb
    unset _continue
}
...
alias mci='echo "--> mvn clean install -U -Dmaven.test.skip=true"; sleep ${__ALIAS_TIMEOUT__}; sjp; mvn clean install -U -Dmaven.test.skip=true'
alias mcc='echo "--> mvn -T 1C clean compile -Dmaven.test.skip=true --offline"; sleep ${__ALIAS_TIMEOUT__}; sjp; mvn -T 1C clean compile -Dmaven.test.skip=true --offline'
alias mcp='echo "--> mvn -T 1C clean package -Dmaven.test.skip=true --offline"; sleep ${__ALIAS_TIMEOUT__}; sjp; mvn -T 1C clean package -Dmaven.test.skip=true --offline'
alias mp='echo "--> mvn -T 1C package -Dmaven.test.skip=true --offline"; sleep ${__ALIAS_TIMEOUT__}; sjp; mvn -T 1C package -Dmaven.test.skip=true --offline'
alias mrjr='echo "--> mvn -T 1C resources:resources jar:jar spring-boot:repackage -Dmaven.test.skip=true --offline"; sleep ${__ALIAS_TIMEOUT__}; sjp; mvn -T 1C resources:resources jar:jar spring-boot:repackage -Dmaven.test.skip=true --offline'
alias mrr='echo "--> mvn resources:resources"; sleep ${__ALIAS_TIMEOUT__}; sjp; mvn resources:resources'
alias mec='echo "--> mvn clean eclipse:clean"; sleep ${__ALIAS_TIMEOUT__}; sjp; mvn clean eclipse:clean'
alias mdr='echo "--> mvn dependency:resolve -U"; sleep ${__ALIAS_TIMEOUT__}; sjp; mvn dependency:resolve -U'
alias mdt='echo "--> mvn dependency:tree"; sleep ${__ALIAS_TIMEOUT__}; sjp; mvn dependency:tree'
...
alias sj25='__jh_set_java_version 25'
...
alias sjp='__jh_from_pom_set_java_version'



function __jh_from_number_set_java_version {
    if [ -z ${1} ] ; then
        echo 'param ${1} empty; ${__JH_JAVA_VERSION_DEFAULT__}: '${__JH_JAVA_VERSION_DEFAULT__}
        _p_java_version=${__JH_JAVA_VERSION_DEFAULT__}
    fi
...
function __jh_jjr { 
	...
	jarfile=$( ls ./target/*.jar )
	jarlogfile=${__JH_JAR_LOG_HOME_DEFAULT__}/$( basename ${jarfile} )'.log'
...
function __jh_jjrg {
    ...
    # __JH_JAR_LOG_HOME_DEFAULT__=${HOME}'/Desktop/log' # deprecated
    echo 'jar log home: '${__JH_JAR_LOG_HOME_DEFAULT__}

    if [ -e ./target/*jar ]
    then
        jarfile=$( command ls ./target/*.jar )
        _cmd_str='command grep --color=always -P -i '\'"${1}"\'' '${__JH_JAR_LOG_HOME_DEFAULT__}/$( basename $( command ls ./target/*jar ) )'.log'
        echo "${_cmd_str}"
        eval ${_cmd_str}
	__grc__=${?}
        unset _cmd_str
...
function __jh_sb2_bootstrap_prop_for_local {
...
alias _jh_sb2_bl='__jh_sb2_bootstrap_prop_for_local'



function __jh_sb2_bootstrap_prop_for_commit {
...
alias _jh_sb2_bo='__jh_sb2_bootstrap_prop_for_commit'



function __jh_sb3_application_yml_for_local {
...
alias _jh_sb3_bl='__jh_sb3_application_yml_for_local'



function __jh_sb3_applicaton_yml_for_commit {
...
alias _jh_sb3_bo='__jh_sb3_applicaton_yml_for_commit'



alias bl='_jh_sb2_bl ; _jh_sb3_bl'
alias bo='_jh_sb2_bo ; _jh_sb3_bo'



function __jh_bl_tk_mcp {
    echo -e '--> bl ; tk ; mcp ; \n'
    bl ; tk ; mcp
}

alias lc='__jh_bl_tk_mcp'



function __jh_bl_tk_mrr {
    echo -e '--> bl ; tk ; mrr ; \n'
    bl ; tk ; mrr
}

alias lr='__jh_bl_tk_mrr'



function __jh_bl_tk_mrjr {
    echo -e '--> bl ; tk ; mrjr ; \n'
    bl ; tk ; mrjr
}

alias lrj='__jh_bl_tk_mrjr'



function __jh_java_vars_print {
    echo '--> java vars: '
    echo '__JH_XMS__: '${__JH_XMS__}
    echo '__JH_XMX__: '${__JH_XMX__}
    echo '__JH_SPRING_PROFILES_ACTIVE__: '${__JH_SPRING_PROFILES_ACTIVE__}
    echo
    echo '--> java vars, default: '
    echo '__JH_XMS_DEFAULT__: '${__JH_XMS_DEFAULT__}
    echo '__JH_XMX_DEFAULT__: '${__JH_XMX_DEFAULT__}
    echo '__JH_SPRING_PROFILES_ACTIVE_DEFAULT__: '${__JH_SPRING_PROFILES_ACTIVE_DEFAULT__}
}
alias jvp='__jh_java_vars_print'


function __jh_java_vars_set {
    if [[ ( -z ${1} ) || ( -z ${2} ) || ( -z ${3} ) ]] ; then
        echo 'you must provide three parameters: __JH_XMS__, __JH_XMX__, __JH_SPRING_PROFILES_ACTIVE__'
        echo 'see default values'
        return 1
    fi
    echo '--> set from ${1}, ${2}, ${3}'
    echo
    __JH_XMS__=${1}
    __JH_XMX__=${2}
    __JH_SPRING_PROFILES_ACTIVE__=${3}
    __jh_java_vars_print
}
alias jvs='__jh_java_vars_set'


function __jh_java_vars_set_from_defaults {
    echo '--> set from defaults'
    echo
    __JH_XMS__=${__JH_XMS_DEFAULT__}
    __JH_XMX__=${__JH_XMX_DEFAULT__}
    __JH_SPRING_PROFILES_ACTIVE__=${__JH_SPRING_PROFILES_ACTIVE_DEFAULT__}
...
alias jvd='__jh_java_vars_set_from_defaults'
...
--> Java Helper -- updated: (${__ALIAS_LAST_UPDATE__})
	  ...
	  jvp: __jh_java_vars_print
	  jvs: __jh_java_vars_set
	  jvd: __jh_java_vars_set_from_defaults

	  sjp  : __jh_from_pom_set_java_version    # helper function
	  sj17 : __jh_from_number_set_java_version # helper function
	  ...
	  bl  : sb2-bootstrap.prop / sb3-application.yml, for local
	  bo  : sb2-bootstrap.prop / sb3-application.yml, for commit
